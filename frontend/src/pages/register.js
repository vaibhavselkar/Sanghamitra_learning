...
const RegisterPage = () => {
    ...
    const validateTutorCode = async (code) => {
      ...
      try {
        const response = await fetch(`https://sanghamitra-learning-server.vercel.app/api/classrooms/validate/${code}`);
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        // Make the API call
        const response = await fetch('https://sanghamitra-learning-server.vercel.app/api/register', {
          method: 'POST',
          headers: {
